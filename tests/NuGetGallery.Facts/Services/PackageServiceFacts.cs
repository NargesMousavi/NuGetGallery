...
namespace NuGetGallery
{
    public class PackageServiceFacts
    {
        ...
        public class TheGetPagedPackagesByOwnerMethod : TheFindPackagesByOwnersMethodsBase
        {
            ...
            {
                return PackageService.GetPagedPackagesByOwner(user, page, pageSize, includeUnlisted, includeVersions);
            }
            ...
            [Theory]
            [InlineData(1, "package2")]
            [InlineData(2, "package1")]
            public void PaginationWhenContextContainsMoreThanPageSizeResults(int page, string expectedPackage)
            {
                this.page = page;
                this.pageSize = 1;
                ...
                Assert.Equal(pageSize, packages.Count);
